...
| 9 | Exact-SHA approval, merge, staging, smoke, and Done transition | 7 and 8 | `review` | `.worktrees/block7-delivery`; `feat/block-7-delivery` | `docs/superpowers/plans/2026-08-09-block-7-delivery.md` | — | `27d32af` |
